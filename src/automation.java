...
public class automation {
    ...
    public static void main (String arg[]) throws MalformedURLException {
        ...
        el4.click();
        MobileElement el5 = (MobileElement) ad.findElementById("com.android.calculator2:id/digit_0");
        el5.click();
        MobileElement el6 = (MobileElement) ad.findElementByAccessibilityId("equals");
        el6.click();

        Assert.assertEquals(ad.findElementById("com.android.calculator2:id/result").getText(),45);
    }
}
